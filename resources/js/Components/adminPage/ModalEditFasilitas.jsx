...
const ModalEditFasilitas = ({ item }) => {
    ...
    const submitHandler = (e) => {
        ...
        put(`/fasilitas/${item?.id}`, {
            preserveScroll: true,
            onSuccess: () => {
                window.modal_edit_fasilitas.close();
                reset();
            },
        });
    };
    ...
    return (
        <div>
            ...
            >
                ...
                >
                    <button
                        onClick={() => window.modal_edit_fasilitas.close()}
                    ...
                    <div className="flex flex-col md:p-2 py-2 w-full">
                        <h1 className="text-2xl font-semibold mb-3">
                            Edit Fasilitas Property {item?.attribute}
                        </h1>
                        <form
