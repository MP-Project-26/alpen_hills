...
const ModalTambahCategoryPost = ( ) => {
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        post("/admin/categoryPost/add", {
            onSuccess: () => {
                window.modal_tambah_category_post.close();
                reset();
            },
        });
    ...
    return (
        <div>
            ...
            >
                ...
                >
                    <button
                        onClick={() => window.modal_tambah_category_post.close()}
...
export default ModalTambahCategoryPost;
