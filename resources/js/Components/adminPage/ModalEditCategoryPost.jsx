...
const ModalEditCategoryPost = ({ ...props }) => {
    ...
    useEffect(() => {
        setData((prevData) => ({
            ...prevData,
            name: props?.categoryPost?.name || "",
            slug: props?.categoryPost?.slug || "",
        }));
    }, [props.categoryPost]);
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        router.post(`/admin/categoryPost/update/${props.categoryPost.id}`, data, {
            preserveScroll: true,
            onSuccess: () => {
                window.modal_edit_category_post.close();
            },
            onError: (errors) => {
                console.log(errors);
            },
...
export default ModalEditCategoryPost;
