                    ...
                    <div className="flex flex-col md:p-2 py-2 w-full">
                        ...
                        >
                            <div className="flex flex-col gap-1">
                                <label htmlFor="name">Tipe Property :</label>
                                <input
                                    className="rounded-md"
                                    type="text"
                                    placeholder="ex : Tipe 5 meter"
                                    id="name"
                                    name="name"
                                    value={data.name}
...
export default ModalTambahTypeProperty;
