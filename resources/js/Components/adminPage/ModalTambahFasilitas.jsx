...
const ModalTambahFasilitas = ({ item }) => {
   ...
   useEffect(() => {
    ...
    const submitHandler = (e) => {
        ...
        post("/fasilitas", {
            ...
            onSuccess: () => {
                reset();
                window.modal_tambah_fasilitas.close();
            },
        });
    };
    ...
    return (
        <div>
            ...
            >
                ...
                >
                    <button
                        onClick={() => window.modal_tambah_fasilitas.close()}
                    ...
                    <div className="flex flex-col md:p-2 py-2 w-full">
                        <h1 className="text-2xl font-semibold mb-3">
                            Tambah Fasilitas Property {item?.name}
                        </h1>
                        <form
